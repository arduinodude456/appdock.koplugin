...
function DAppManager:showAccessibilityEditor(instance, context)
    ...
    dialog = ButtonDialog:new{
        ...
        buttons = {
            { { text = "50%", callback = function() choose({ text_scale = .5 }) end }, { text = "75%", callback = function() choose({ text_scale = .75 }) end }, { text = "90%", callback = function() choose({ text_scale = .9 }) end } },
            { { text = "100%", callback = function() choose({ text_scale = 1 }) end }, { text = "115%", callback = function() choose({ text_scale = 1.15 }) end }, { text = "130%", callback = function() choose({ text_scale = 1.3 }) end } },
            { { text = "150%", callback = function() choose({ text_scale = 1.5 }) end } },
