...
<p>Im Bereich <b>Arrange apps</b> verschiebst du angeheftete Apps mit <b>↑</b> und <b>↓</b>. Die Reihenfolge bestimmt anschließend Raster und Seiten des Launchers und wird lokal gespeichert.</p>
...
<p>In <b>Arrange apps</b>, move pinned apps with <b>↑</b> and <b>↓</b>. The order then determines the launcher grid and pages and is stored locally.</p>
...
<p>Unter <b>Arrange store widgets</b> ordnest du installierte Store-Widgets mit <b>↑</b> und <b>↓</b> an. Die lokale Reihenfolge bestimmt ihre vertikale Reihenfolge auf dem Homescreen. Neue Widgets werden am Ende ergänzt; entfernte Widgets werden aus der Reihenfolge bereinigt.</p>
...
<p>Under <b>Arrange store widgets</b>, move installed Store widgets with <b>↑</b> and <b>↓</b>. The local order determines their vertical homescreen order. New widgets are appended; removed widgets are cleaned from the order.</p>
...
<p>Die integrierten DApps sind Analog Clock, Settings, Files, AppStore, Web Browser und Help. Installierte Store-DApps folgen demselben Pane-Vertrag und können – sofern ihre Oberfläche auf kleinem Raum lesbar bleibt – ebenfalls im Splitscreen laufen.</p>]], [[
...
<p>Built-in DApps are Analog Clock, Settings, Files, AppStore, Web Browser and Help. Installed Store DApps use the same pane contract and can also run in split screen when their UI remains readable in the reduced space.</p>]]),
...
<p><b>Network</b> enthält Wi-Fi und den transparent markierten Bluetooth-Eintrag. Bluetooth wird von dieser AppDock-Version nicht als Einstellungsfunktion angeboten.</p>
<p><b>Display</b> öffnet die nativen KOReader-Lichtsteuerungen, verwaltet Farbthemen und Launcher layout. <b>Storage</b> scannt lokale AppDock-Daten, zeigt eine kompakte Belegungsübersicht und listet installierte Store-DApps nach Dateigröße.</p>
...
<p><b>Network</b> contains Wi-Fi and a clearly marked Bluetooth entry. Bluetooth is not offered as a settings function by this AppDock version.</p>
<p><b>Display</b> opens native KOReader light controls, manages color themes, and opens Launcher layout. <b>Storage</b> scans local AppDock data, shows a compact usage overview, and lists installed Store DApps by file size.</p>
